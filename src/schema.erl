...
setup_games() ->
  ...
  mnesia:dirty_write(#tab_game_config{id = 1, module = game, mods = ?DEF_MOD, limit = Limit, seat_count = 9, start_delay = ?START_DELAY, required = 2, timeout = 1000, max = 10}).
...
setup_players() ->
  mnesia:dirty_write(#tab_player_info{pid = 1, identity = "player", password = ?DEF_HASH_PWD, nick = "nick", photo = "default.png", cash = 10000}),
  mnesia:dirty_write(#tab_player_info{pid = 2, identity = "robot", password = ?DEF_HASH_PWD, nick = "robot", photo = "2012491443.jpg", cash = 10000}),
  mnesia:dirty_write(#tab_player_info{pid = 3, identity = "robot_foo", password = ?DEF_HASH_PWD, nick = "robot foo", photo = "2011962129360.jpg", cash = 10000}),
  mnesia:dirty_write(#tab_player_info{pid = 4, identity = "robot_doo", password = ?DEF_HASH_PWD, nick = "robot doo", photo = "2012491439.jpg", cash = 10000}),
